...
The detailed indicator table and source geospatial layers are not included in the public repository. See [`../DATA_SOURCES.md`](../DATA_SOURCES.md) for dataset citations and availability.
